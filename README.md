...
Example: [GDPR for things](https://www.slideshare.net/sasvangent/gdpr-for-things-thingscon-amsterdam-2017/1)
...
Example: [Arduino privacy policy](https://www.arduino.cc/en/Main/PrivacyPolicy/)
